...
SSH means **S**ecure **Sh**ell, primarily it is used to access a command line 
...
As a ssh session can be used to open a command line session on another machine, 
...
Most IDE's now support remote development, where the IDE connects through SSH to 
